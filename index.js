...
function superbowlWin(yearAndResultPairs) {

  let year;
  let x;

  yearAndResultPairs.find(function(yearAndResultPair) {
    if (yearAndResultPair.result === "W") {
      year = yearAndResultPair.year;
      console.log(year);
    }

    else if (yearAndResultPair.result !== "W") {
      x = undefined;
      console.log(x);
    }
